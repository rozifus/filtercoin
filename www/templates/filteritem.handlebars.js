...
templates['filteritem'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
function program2(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "\n</div>\n<div class=\"content\">\n  ";
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.sub), {hash:{},inverse:self.noop,fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</div>\n\n";
  return buffer;
  });
